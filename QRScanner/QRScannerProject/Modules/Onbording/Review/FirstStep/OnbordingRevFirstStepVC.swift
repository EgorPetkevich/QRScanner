...
protocol OnbordingRevFirstStepViewModelProtocol {
    var delayAnimation: (() -> Void)? { get set }
    
    func continueButtonDidTap()
}

final class OnbordingRevFirstStepVC: UIViewController {
    ...
    private lazy var subTitleLabel: UILabel = 
        .reviewSubtitle("Simply open the app and start scanning QR codes<br>instantly&#8212no additional taps required.")
    ...
    private var viewModel: OnbordingRevFirstStepViewModelProtocol
    
    init(viewModel: OnbordingRevFirstStepViewModelProtocol) {

...
protocol LinkResultViewModelProtocol {
    func getText() -> String
...
final class LinkResultVC: UIViewController {
    ...
    ResultTypeView(image: .Result.linkImage, text: "URL")
    ...
    private var viewModel: LinkResultViewModelProtocol
    
    init(viewModel: LinkResultViewModelProtocol) {

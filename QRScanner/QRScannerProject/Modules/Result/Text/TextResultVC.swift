...
protocol TextResultViewModelProtocol {
    func getText() -> String
...
final class TextResultVC: UIViewController {
    ...
    ResultTypeView(image: .Result.textImage, text: "Text")
    private lazy var resultView: InfoResultView =
    InfoResultView(self,
                   image: .Result.textImage,
    ...
    private var viewModel: TextResultViewModelProtocol
    
    init(viewModel: TextResultViewModelProtocol) {
